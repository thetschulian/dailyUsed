...
set "adminScript=%basicTempDir%\Windows-Admin-Tasks.cmd"
	...
	echo powercfg -setdcvalueindex SCHEME_CURRENT SUB_PROCESSOR PROCTHROTTLEMAX 100 >> "%adminScript%"
	echo powercfg -setacvalueindex SCHEME_CURRENT SUB_PROCESSOR PROCTHROTTLEMAX 100 >> "%adminScript%"
